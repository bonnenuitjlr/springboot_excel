package com.xingyu.execl.util.execl;
...
public class ExcelUtil {
     ...
     */
    public static <T> byte[] exportExcelByte(Map<String, String> headers, Collection<T> dataset) {
        // 声明一个工作薄
    ...
    private static int setCellValue(HSSFCell cell, Object value, String pattern, int cellNum, Field field, HSSFRow row) {
        ...
        if (value instanceof Integer) {
            ...
            String empty = "";
            if (field != null) {
                ExcelExportUtils.ExcelCell anno = field.getAnnotation(ExcelExportUtils.ExcelCell.class);
                if (anno != null) {
                        ...
                        if (field.getType().isArray()) {
                            ...
                            if (isBlank(errMsg)) {
                                ...
                                if (field.getType().equals(Date.class)
                                    ...
                                    ExcelExportUtils.ExcelCell annoCell = field.getAnnotation(ExcelExportUtils.ExcelCell.class);
    ...
    private static List<FieldForSortting> sortFieldByAnno(Class<?> clazz) {
        ...
        for (Field field : fieldsArr) {
            ExcelExportUtils.ExcelCell ec = field.getAnnotation(ExcelExportUtils.ExcelCell.class);
            if (ec == null) {
